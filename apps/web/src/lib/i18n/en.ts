export const en = {
  ...
  ragDemo: {
    label: '// rag_demo',
    title: 'RAG Demo',
    description: 'Upload a document, then ask questions. Powered by pgvector + LangChain LLM.',
    uploadStep: '1. Upload Document',
    uploadPlaceholder: 'Drop a PDF or click to upload',
    uploadIndexed: '✓ indexed',
    queryStep: '2. Ask a Question',
