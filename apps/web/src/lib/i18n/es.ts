...
export const es: Dictionary = {
  ...
  ragDemo: {
    label: '// demo_rag',
    title: 'Demo de RAG',
    description: 'Subí un documento y hacé preguntas. Powered by pgvector + LangChain LLM.',
    uploadStep: '1. Subir Documento',
    uploadPlaceholder: 'Arrastrá un PDF o cliqueá para subir',
    uploadIndexed: '✓ indexado',
    queryStep: '2. Hacer una Pregunta',
