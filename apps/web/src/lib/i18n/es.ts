...
export const es: Dictionary = {
  ...
  demos: {
    ...
    rag: {
      title: 'Demo de RAG',
      description:
        'Sube documentos y consúltalos usando generación aumentada por recuperación con pgvector.',
    },
    agents: {
  ...
  chatDemo: {
    ...
    inputPlaceholder: 'Pregunta lo que quieras sobre sistemas de IA...',
    sendAria: 'Enviar',
  ...
  agentsDemo: {
    ...
    subtitleSuffix: 'loop con arista condicional · haz clic en cualquier nodo para ver detalles',
    ...
    panel: {
      ...
      noTools: 'No hay herramientas conectadas. Define',
    ...
    footer:
      'Haz clic en cualquier nodo para inspeccionarlo: ver el modelo y el system prompt de agent, las herramientas asociadas y sus descripciones para tools, o el rol de __start__ / __end__ en el runtime de LangGraph.',
    inspectState: 'inspeccionar estado →',
  },
  memoryDemo: {
    label: '// demo_memoria',
    ...
    description:
      "Hechos sobre ti que el agente recuerda entre threads. Guardados en Postgres vía AsyncPostgresStore de LangGraph bajo ('memories', user_id).",
    userIdLabel: 'user_id',
    entryCount: (n: number) => `${n} ${n === 1 ? 'entrada' : 'entradas'}`,
    refresh: 'refrescar',
    clearAll: 'borrar todo',
    noEntriesTitle: 'Aún no hay memorias',
    noEntriesHint: 'Chatea con el agente o agrega una entrada abajo.',
    ...
    footer:
      'El grafo del agente tiene nodos load_memory y save_memory. En cada turno levanta los hechos relevantes para tu user_id y, tras responder, extrae nuevos hechos durables vía el LLM y los persiste aquí.',
  },
  ragDemo: {
    label: '// demo_rag',
    title: 'Demo de RAG',
    descBefore: 'Sube hasta',
    descMiddle:
      'documentos y haz preguntas ancladas en su contenido. Los mismos documentos están disponibles desde el',
    ...
    limitDelete: 'Elimina un documento para subir otro',
    uploadDrop: 'Arrastra un PDF, TXT o MD — o haz clic para subir',
    loading: 'cargando…',
    ...
    querying: 'Buscando…',
    uploadFirst: 'Sube un documento primero.',
    answer: 'Respuesta',
    modelLabel: 'modelo:',
