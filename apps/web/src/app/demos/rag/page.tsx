      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-lg border border-border bg-surface p-6">
          ...
          <div
            ...
            className="flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-border p-8 transition-all hover:border-accent-cyan/40"
          >
        ...
        <div className="rounded-lg border border-border bg-surface p-6">
          ...
          <form onSubmit={handleQuery} className="flex flex-col gap-3">
            <textarea
              ...
              rows={4}
              className="w-full resize-none rounded-lg border border-border bg-surface-2 px-4 py-3 text-sm text-text-primary placeholder-text-muted outline-none transition-all focus:border-accent-cyan/50"
            />
            <button
              type="submit"
